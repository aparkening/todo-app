...
export const COLORS = {
  ...
  background: '#F9FAFC',
  today: '#FF006E',
  todayBackground: 'rgba(255, 0, 110, 0.05)',
  tomorrow: '#FB5607',
  tomorrowBackground: 'rgba(251, 86, 7, 0.05)',
  thisWeek: '#FFBE0B',
  thisWeekBackground: 'rgba(255, 190, 11, 0.05)',
  noDate: '#9D9FA7',
  noDateBackground: '#F9FAFB',
  completed: '#03CEA4',
  completedBackground: 'rgba(3, 206, 164, 0.05)',
